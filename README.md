...
a mobile-first, deep=learning plateform that identifies bird species from user-uploaded images. the prject utilizes transfer learning with **MobileNetV3Large** via tensorflow, exports the optimized computational graph into **ONNX Runtime**, and serves a clean web interface using **Streamlit**.
